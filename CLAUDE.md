...
- `src/mill.ts` — Core converter registry. Tries converters in priority order.
...
- **URL support**: `mill https://example.com` fetches with `Accept: text/markdown` header
...
3. Import and add to the converters array in `src/mill.ts`
